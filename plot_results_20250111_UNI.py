...
def plot_jinlin_evaluation_boxplots():
    ...
    save_root = '/Users/zhongz2/down/temp_20250111'
    ...
    for expname in ['overall']: #, 'R0_vs_R2R4']:
        ...
        for group in groups:
            ...
            if expname == 'overall':
                ...
                df4 = (df3[group].value_counts()//2).loc[hue_order].reset_index()
                # pie chart
            ...
            if False:
                ...
                hue_order_new = []
                for v in hue_order:
                    hue_order_new.append(mapper_dict[v])
                ...
                fig = plt.figure(figsize=(figure_width, figure_height), frameon=False)
                ax = plt.gca()
                g=sns.catplot(data=df31, x=group, y="score", hue="method", kind="box", palette=palette, ax=ax, order=hue_order_new, legend=False)
                # if group=='structure':
