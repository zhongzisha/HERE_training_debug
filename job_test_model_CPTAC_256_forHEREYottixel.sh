...
DATA_H5_DIR="/data/zhongz2/CPTAC/yottixel_mosaic_h5_for_HERE"
DATA_SLIDE_DIR="/data/zhongz2/CPTAC/svs"
hidare_method_postfix=${MODEL_NAME}
FEATS_DIR=/data/zhongz2/CPTAC/patches_256/${MODEL_NAME}
FEATS_DIR=/data/zhongz2/CPTAC/yottixel_mosaic_h5_for_HERE_feats/${MODEL_NAME}
mkdir -p $FEATS_DIR
...
job_test_model_CPTAC_256_forHEREYottixel.sh ${MODEL_NAME}
