...
python generate_faiss_index_v2_CPTAC_intersection.py ${1} ${2} ${3}


exit;

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED CONCH 0
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED PLIP 0
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED ProvGigaPath 0

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 CONCH 0
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 PLIP 0
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 ProvGigaPath 0

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 UNI 0
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED UNI 0
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=4 --partition=multinode --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh ST UNI 0

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=2 --partition=gpu --gres=gpu:v100x:1 --ntasks-per-node=1 --mem=500G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 CONCH 1
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=2 --partition=gpu --gres=gpu:v100x:1 --ntasks-per-node=1 --mem=300G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED CONCH 1

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=2 --partition=gpu --gres=gpu:v100x:1 --ntasks-per-node=1 --mem=300G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 PLIP 1

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=2 --partition=largemem --ntasks-per-node=1 --mem=500G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED PLIP 1
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=2 --partition=largemem --ntasks-per-node=1 --mem=500G \
    generate_faiss_index_v2_CPTAC_intersection.sh KenData_20240814 ProvGigaPath 1
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=2 --partition=largemem --ntasks-per-node=1 --mem=500G \
    generate_faiss_index_v2_CPTAC_intersection.sh TCGA-COMBINED ProvGigaPath 1
...
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=1 --partition=norm --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh CPTAC_BRCA CONCH 0
...
do
sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=1 --partition=norm --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh CPTAC_${cancer} CONCH 0
sleep 1
done

sbatch --time=108:00:00 --cpus-per-task=4 --ntasks=1 --partition=norm --ntasks-per-node=1 --mem=100G \
    generate_faiss_index_v2_CPTAC_intersection.sh CPTAC CONCH 0
